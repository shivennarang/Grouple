...
const AboutGroup = ({ groupid, userid }: Props) => {
    ...
    const handleDeleteMedia = (mediaUrl: string) => {
        // Logic to handle deletion of the media item
        console.log(`Deleting media with URL: ${mediaUrl}`)
        // Implement deletion logic here (e.g., update the state or call an API)
    }
    if (!group)
        return (
            <div>
    ...
    return (
        <div className="flex flex-col gap-y-10">
            ...
            <MediaGallery
                ...
                onDelete={deleteMediaItem} // Add onDelete prop here
            />
            {userid !== group.userId ? (
