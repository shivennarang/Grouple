...
import { Interactions } from "./interactoions"
import { PostAuthor } from "./post-autor"
...
export const PostCard = ({
  ...
  return (
    <Card className="border-themeGray bg-[#1A1A1D] first-letter:rounded-2xl overflow-hidden min-w-[400px]">
